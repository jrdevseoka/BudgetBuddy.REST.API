...
`APP_DESCRIPTION`, `APP_VERSION`, `APP_PORT`, `APP_IS_PRODUCTION`, `MSSQL_HOST`, `MSSQL_PORT`,
`MSSQL_DB`, `MSSQL_USER`, and `MSSQL_PASSWORD`. This schema can be used to validate the
...
export const validationSchema = Joi.object({
  ...
  DB_TYPE: Joi.string().required().valid('postgres', 'mssql'),
